...
const AdminSidebar = () => {
 ...
 /* { to: "/admin/transaction-reports", icon: "📑", label: "Transaction Cotton Reports" },*/
 /* { to: "/admin/cotton-reports", icon: "📊", label: "Transaction Cotton Reports" }
];
...
const processStockTransactionItems = [
  { to: "/admin/department-kg", icon: "📝", label: "Department KGs" },
  { to: "/admin/countwise-closing", icon: "🔄", label: "Countwise Closing" },
  { to: "/admin/waste-issue", icon: "📤", label: "Waste Issue" },
];
  /* ---------------- LOGOUT ---------------- */
